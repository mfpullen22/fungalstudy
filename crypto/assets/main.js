...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('h1.style2, h2.style2, h3.style2, p.style2', { style: 'fade-up', speed: 750, intensity: 1, threshold: 1, delay: 0, replay: false });
		onvisible.add('h1.style7, h2.style7, h3.style7, p.style7', { style: 'fade-up', speed: 750, intensity: 1, threshold: 1, delay: 0, replay: false });
		onvisible.add('h1.style3, h2.style3, h3.style3, p.style3', { style: 'fade-up', speed: 750, intensity: 1, threshold: 1, delay: 0, replay: false });
